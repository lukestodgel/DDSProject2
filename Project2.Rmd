...
MeanSensNB = colMeans(masterSensitivityNB)
MeanSpecNB = colMeans(masterSpecificityNB)

CM

which.max(MeanAccNB)
which.max(MeanSensNB)
which.max(MeanSpecNB)
...
# (b) Compute R-square -- how well the model fits the data
...
# Manufacturing Director p value = 0.279
# Sales Executive p value = 0.708

# Step 4 Calculate Test Statistic
# T value for the intercept is 18.375.
# T value for each of the different job roles varied. Only two were statistically significant enough to impact MonthlyIncome. Those two roles were Manufacturing Director and Sales Executive.
# Total Working years also did not have a statistically significant T value.
...
# For Manufacturing Directors and Sales Executives we can't, with extreme certainty, declare that their role + total working years does not affect their salary.
